...
export default (props) => {
  ...
  return (
    <Layout className='signin layout'>
      ...
      <Content style={{ display: 'flex', alignItems: 'center', justifyContent: 'center', flexDirection: 'column' , marginTop: "70px"}}>
        <Card className = "forms" style={{ display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
          <Form
            name='basic'
          ...
          >
            ...
            <Form.Item
              ...
              rules={[
                {
                  required: true,
                  message: 'Please input your Student-ID/Teacher-ID!',
                },
              ]}
            >
              <Input
            ...
            <Form.Item>
              <Button 
                ...
                htmlType='submit' 
                loading={loading}
                style = {{backgroundColor:"black", borderRadius:"10px", width: "100px"}} >
                Submit
              </Button>
            </Form.Item>
          </Form>
